<?php
/** Banda CTA full-width reutilizable. Variables opcionales: $titulo, $texto, $variant ('navy'|'teal'). */
$titulo  = $titulo  ?? '¿Listo para tener todo bajo control?';
$texto   = $texto   ?? 'Contanos qué necesitás y te armamos una cotización a medida. Sin compromiso.';
$variant = $variant ?? 'navy';
?>
<section class="cta-band cta-band--<?= e($variant) ?>">
  <div class="container cta-band__inner">
    ...
    <div class="cta-band__actions">
      ...
      <a class="btn btn-whatsapp" href="<?= e(whatsapp_url()) ?>" target="_blank" rel="noopener">
